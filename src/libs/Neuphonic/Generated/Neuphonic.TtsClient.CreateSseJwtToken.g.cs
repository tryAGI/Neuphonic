...
namespace Neuphonic
{
    public partial class TtsClient
    {
        ...
        private static readonly global::Neuphonic.EndPointSecurityRequirement s_CreateSseJwtTokenSecurityRequirement0 =
        ...
        private static readonly global::Neuphonic.EndPointSecurityRequirement[] s_CreateSseJwtTokenSecurityRequirements =
            new global::Neuphonic.EndPointSecurityRequirement[]
            {                s_CreateSseJwtTokenSecurityRequirement0,
            };
        partial void PrepareCreateSseJwtTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? expiration);
        partial void PrepareCreateSseJwtTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? expiration);
        partial void ProcessCreateSseJwtTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSseJwtTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neuphonic.JwtTokenResponse> CreateSseJwtTokenAsync(
            int? expiration = default,
            global::Neuphonic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateSseJwtTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neuphonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neuphonic.AutoSDKHttpResponse<global::Neuphonic.JwtTokenResponse>> CreateSseJwtTokenAsResponseAsync(
            int? expiration = default,
            global::Neuphonic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSseJwtTokenArguments(
            ...
            var __authorizations = global::Neuphonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSseJwtTokenSecurityRequirements,
                operationName: "CreateSseJwtTokenAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSseJwtTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neuphonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neuphonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSseJwtToken",
                                methodName: "CreateSseJwtTokenAsync",
                                pathTemplate: "\"/sse/auth\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSseJwtTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neuphonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw new global::Neuphonic.ApiException<global::Neuphonic.HTTPValidationError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSseJwtTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neuphonic.JwtTokenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neuphonic.AutoSDKHttpResponse<global::Neuphonic.JwtTokenResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neuphonic.JwtTokenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
