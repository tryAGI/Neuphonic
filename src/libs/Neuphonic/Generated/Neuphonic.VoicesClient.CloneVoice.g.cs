...
namespace Neuphonic
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Neuphonic.EndPointSecurityRequirement s_CloneVoiceSecurityRequirement0 =
        ...
        private static readonly global::Neuphonic.EndPointSecurityRequirement[] s_CloneVoiceSecurityRequirements =
            new global::Neuphonic.EndPointSecurityRequirement[]
            {                s_CloneVoiceSecurityRequirement0,
            };
        partial void PrepareCloneVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceName,
            ref string? voiceTags,
            ref string? langCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Neuphonic.VoiceMutationResponse> CloneVoiceAsync(
            string voiceName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neuphonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neuphonic.AutoSDKHttpResponse<global::Neuphonic.VoiceMutationResponse>> CloneVoiceAsResponseAsync(
            string voiceName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareCloneVoiceArguments(
                ...
                voiceName: ref voiceName,
                voiceTags: ref voiceTags,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("voice_name", voiceName)
                                .AddOptionalParameter("voice_tags", voiceTags)
                                .AddOptionalParameter("lang_code", langCode)
                                ;
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __contentVoiceFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.VoiceFilename is null
                                    ...
                                    : (global::System.IO.Path.GetExtension(request.VoiceFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentVoiceFile,
                                name: "\"voice_file\"",
                                fileName: request.VoiceFilename != null ? $"\"{request.VoiceFilename}\"" : string.Empty);
                            if (__contentVoiceFile.Headers.ContentDisposition != null)
                            {
                                __contentVoiceFile.Headers.ContentDisposition.FileNameStar = null;
                            }
        ...
        public async global::System.Threading.Tasks.Task<global::Neuphonic.VoiceMutationResponse> CloneVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neuphonic.CloneVoiceRequest
            {
                VoiceFile = voiceFile,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            voiceFile = voiceFile ?? throw new global::System.ArgumentNullException(nameof(voiceFile));
            var request = new global::Neuphonic.CloneVoiceRequest
            {
                VoiceFile = global::System.Array.Empty<byte>(),
                VoiceFilename = voiceFilename,
            };
            PrepareArguments(
                client: HttpClient);
