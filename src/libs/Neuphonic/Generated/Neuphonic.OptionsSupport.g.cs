...
namespace Neuphonic
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Neuphonic.AutoSDKRetryOptions Retry { get; set; } = new global::Neuphonic.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Neuphonic.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Neuphonic.IAutoSDKHook>();
        ...
        public global::Neuphonic.AutoSDKClientOptions AddHook(
            global::Neuphonic.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Neuphonic.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Neuphonic.AutoSDKClientOptions UseAuthorizationProvider(
            global::Neuphonic.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Neuphonic.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Neuphonic.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Neuphonic.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Neuphonic.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Neuphonic.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Neuphonic.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Neuphonic.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Neuphonic.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Neuphonic.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Neuphonic.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Neuphonic.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Neuphonic.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Neuphonic.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Neuphonic.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Neuphonic.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Neuphonic.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Neuphonic.AutoSDKClientOptions clientOptions,
            global::Neuphonic.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Neuphonic.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Neuphonic.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Neuphonic.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Neuphonic.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Neuphonic.IAutoSDKHook, global::Neuphonic.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Neuphonic.AutoSDKHookContext context)
        {
