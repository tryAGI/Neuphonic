...
namespace Neuphonic.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Neuphonic.CLI";
    private const string UserSecretApiKeyName = "NEUPHONIC_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"NEUPHONIC_API_KEY"];
    private const string CredentialFileDirectoryName = ".neuphonic";

    public static async global::System.Threading.Tasks.Task<global::Neuphonic.NeuphonicClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Neuphonic.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Neuphonic.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Neuphonic.NeuphonicClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Neuphonic.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Neuphonic.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Neuphonic.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Neuphonic.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("NEUPHONIC_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Neuphonic.ApiException exception)
    {
        var builder = new StringBuilder();
