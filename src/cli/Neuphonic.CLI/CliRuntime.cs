...
internal static class CliRuntime
{
    ...
    public static async Task<global::Neuphonic.NeuphonicClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Neuphonic.ApiException exception)
    {
        var builder = new StringBuilder();
